...
export type AsyncRequestHandler<T = any> = (req: Request, res: Response<T>, next: NextFunction) => Promise<void>;
export type SyncRequestHandler<T = any> = (req: Request, res: Response<T>, next: NextFunction) => void;
